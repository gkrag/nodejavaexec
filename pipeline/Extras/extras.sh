...
then
  ...
  if [ $JAVAMAJOR -lt 1 -o $JAVAMINOR -lt 6 ]
  then    
    echo
    ...
    echo "       Java 6 (or later) is installed on the system and edit this"
  ...
  echo
  echo "Error: Java 6 was not found on your system path. Make sure Java 6"
...
# Set classpath
DIR=`dirname $0`
CP=$DIR/DigiAccessExtras.jar:$DIR
